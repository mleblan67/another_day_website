...
function ready() {
  ...
  order_product.innerHTML =
    ...
    "<br>" +
    "Color: " +
    itemInfo.color.replace("_", " ") +
    "<br>" +
    "Size: " +
    itemInfo.size.toUpperCase() +
    "</strong>";
  ...
  for (
    let i = 0;
    i < document.getElementsByClassName("info-input").length;
    i++
  ) {
    document
      .getElementsByClassName("info-input")
      [i].addEventListener("focusout", calculate_shipping);
  }
